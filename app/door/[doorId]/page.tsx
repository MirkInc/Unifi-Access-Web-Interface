...
import { DoorDetailClient } from './DoorDetailClient'
...
export default async function DoorDetailPage({ params }: PageProps) {
  ...
  if (sessionUser.role === 'admin') {
    ...
    const dp = access?.doorPermissions.find((dp) => dp.doorId.toString() === door._id.toString())
  ...
  // Fetch tenants for the header switcher
